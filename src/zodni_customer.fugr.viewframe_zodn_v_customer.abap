*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZODN_V_CUSTOMER
*   generation date: 03.12.2021 at 11:00:44
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZODN_V_CUSTOMER     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZODN_V_CUSTOMER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZODN_V_CUSTOMER_EXTRACT
TOTAL = ZODN_V_CUSTOMER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZODN_V_CUSTOMER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZODN_V_CUSTOMER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZODN_V_CUSTOMER_EXTRACT
TOTAL = ZODN_V_CUSTOMER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZODN_V_CUSTOMER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZODN_V_CUSTOMER'
...
TOTAL = ZODN_V_CUSTOMER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZODN_V_CUSTOMER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZODN_V_CUSTOMER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZODN_V_CUSTOMER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZODN_V_CUSTOMER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZODN_V_CUSTOMER_EXTRACT
TOTAL = ZODN_V_CUSTOMER_TOTAL
